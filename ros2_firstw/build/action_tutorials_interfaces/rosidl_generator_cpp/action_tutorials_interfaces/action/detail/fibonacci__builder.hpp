...
class Init_Fibonacci_Result_error_message
{
public:
  explicit Init_Fibonacci_Result_error_message(::action_tutorials_interfaces::action::Fibonacci_Result & msg)
  : msg_(msg)
  {}
  ::action_tutorials_interfaces::action::Fibonacci_Result error_message(::action_tutorials_interfaces::action::Fibonacci_Result::_error_message_type arg)
  {
...
class Init_Fibonacci_Result_error_code
{
public:
  explicit Init_Fibonacci_Result_error_code(::action_tutorials_interfaces::action::Fibonacci_Result & msg)
  : msg_(msg)
  {}
  Init_Fibonacci_Result_error_message error_code(::action_tutorials_interfaces::action::Fibonacci_Result::_error_code_type arg)
  {
    msg_.error_code = std::move(arg);
    return Init_Fibonacci_Result_error_message(msg_);
  }
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Fibonacci_Result_error_code sequence(::action_tutorials_interfaces::action::Fibonacci_Result::_sequence_type arg)
  {
    msg_.sequence = std::move(arg);
    return Init_Fibonacci_Result_error_code(msg_);
  }
