...
# ----------------------------------- Nodes -----------------------------------
    ...
    tf2_map_to_base = Node( # Static transform from map to base_link
            package='tf2_ros',
            name='static_transform_map_to_base',
    ...
    tf2_base_to_rslidar = Node( # Static transform from base_link to rslidar
            package='tf2_ros',
            name='static_transform_base_to_rslidar',
            executable='static_transform_publisher',
            arguments=['0', '0', '0', '0', '0', '0', 'base', 'rslidar'],
            parameters=[{'use_sim_time' : use_sim_time}],
            output='screen'
        )
