...
#parametri per kiss-ICP di comodità    
    ...
    max_range = LaunchConfiguration('data.max_range', default=20.0) #di base è 100
    min_range = LaunchConfiguration('data.min_range', default=0.2) #di base è a 0
    mapping_voxel_size = LaunchConfiguration('mapping.voxel_size', default=0.25) #di base è 0.5
    mapping_voxel_points = LaunchConfiguration('mapping.max_points_per_voxel', default=12) #di base è 20
